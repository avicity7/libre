        ...
        <SafeAreaView style ={globalStyles.container}>
            ...
            <DropShadow style = {styles.shadowProp}>
                 <Pressable style = {styles.buyButton}>
                    ...
                    <Text style = {{fontFamily:"NotoSerifRegular", fontSize: 13,alignSelf:'center',textAlign:'center', marginLeft: 15}}>Purchase with Card</Text>
                    <Svg style={{alignSelf:'center',marginLeft:15}} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <DropShadow style = {styles.shadowProp}>
                 <Pressable style = {styles.buyButton}>
                    ...
                    <Text style = {{fontFamily:"NotoSerifRegular", fontSize: 13,alignSelf:'center',textAlign:'center', marginLeft: 15}}>Purchase with BTC</Text>
                    <Svg style={{alignSelf:'center',marginLeft:15}} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <DropShadow style = {styles.shadowProp}>
                 <Pressable style = {styles.buyButton}>
                    <Text style = {{fontFamily:"NotoSerifRegular", fontSize: 13,alignSelf:'center',textAlign:'center', marginLeft: 15}}>Purchase with ETH</Text>
                    <Svg style={{alignSelf:'center',marginLeft:15}} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
